...
modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph/file/13de2a6a1e3e724f5b456.jpg"
)
emoji = gvarstatus("ALIVE_EMOJI") or "⚡️"
alive_text = gvarstatus("ALIVE_TEKS_CUSTOM") or "bastard is online bb!!"
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**[BastardBot](tg://user?id={client.me.id}) is Up and Running.**\n\n"
        f"<b>{alive_text}</b>\n\n"
        ...
        f"    **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id})**"
    )
    try:
